...
impl TrainerParameters for Default {
  ...
  #[inline(always)] fn sentence_starter_lower_bound() -> f64 { 30f64 }
  #[inline(always)] fn include_all_collocations() -> bool { false }
  #[inline(always)] fn include_abbrev_collocations() -> bool { false }
  #[inline(always)] fn collocation_frequency_lower_bound() -> f64 { 1f64 }
}
